...
<?php
	...
	echo "<p><a href='" . "http://localhost:8888/testCodeIgniter/index.php" . "/delete_guildie/delete_guildie_id/" . $user->user_id . "' role='button'><button id='delete' class='btn btn-default'>DELETE</button></a>";
