...
foreach($users as $user) {
		...
		echo "<a href='" . "http://localhost:8888/Fellowship/index.php" . "/update_ctrl/update_guildie_id/" . $user->user_id . "' role='button'><button id='update' class='btn btn-default'>UPDATE</button></a>";
		echo "</p></div></div>";
	}
?>